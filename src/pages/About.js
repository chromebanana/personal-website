 ...
 render() {
 	return (
		<div>
          ...
          I'd like to work in a high performance organisation focused on energy transition.
          ...
          <p className="mv1">With profesional experience: Python, React, Swift, SQL, AWS, Data Analysis and Reporting, PowerBI, Git.</p>
          ...
          <h2>Relevant Interests</h2><p>Federeated Learning, Data Fusion using Baysian Inference, DLTs, Design Theory, Permaculture, Generative Art, Multi-Agent Systems, Cooperatives, Power Dynamics, Non-violent Communication, Wallace & Gromit.</p>
          </div>   
    );
 } 
}
